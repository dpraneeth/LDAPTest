...
public class LDAPTestAD {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = "ldap://mel-dc2:389";
        final String ldapSearchBase = "OU=USERS,OU=REVIT,DC=revit,DC=local";
        
        final String ldapUsername = "Praneeth.Desur@revolutionit.com.au";
        final String ldapPassword = "May@2017";
        
        final String ldapAccountToLookup = "Farshad.Farhadieh@revolutionit.com.au";
        ...
        LDAPTestAD ldap = new LDAPTestAD();
